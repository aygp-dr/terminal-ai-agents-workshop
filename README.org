...
|-------+----------------+-------|
| Claude Code | ✅ Works | Native support |
| Amp | ✅ Works | Native support |
| Gemini CLI | ✅ Works | Native support |
| GitHub Copilot CLI | ✅ Works | Via =gh= extension |
| Efrit | ✅ Works | Pure Elisp |
| Aider | ❌ Build fails | tree-sitter packages need =parser.h= |
| OpenAI Codex CLI | ❌ Unsupported | Explicit FreeBSD check in code |
| Goose | ⚠️ Dep issues | langfuse.decorators module missing |
| Open Interpreter | 🔄 Testing | Large build, untested |
...
~/.emacs.d/.efrit/
├── queues/
│   ├── requests/    # Drop JSON requests here
│   ├── processing/  # Currently being processed
│   ├── responses/   # Completed responses
│   └── archive/     # Historical requests
#+end_example
